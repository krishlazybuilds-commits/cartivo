  ...
  return (
    <form className="newsletter-form" onSubmit={handleSubmit} noValidate>
      <div className={`newsletter-field${isSuccess ? " newsletter-field--success" : ""}`}>
        ...
        >
          {isLoading && (
            <span className="newsletter-dots" aria-label="Sending">
          ...
          {isSuccess && (
            <svg className="newsletter-btn-check" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" aria-label="Subscribed">
