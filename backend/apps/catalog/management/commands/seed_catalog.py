...
PRODUCTS = [
    (
        "LAP-MBA13-M4", "laptops",
        'Apple MacBook Air 13" (M4)', "apple-macbook-air-13-m4",
    ...
    (
        ...
        "Portable IP67 waterproof Bluetooth speaker with bold JBL Original Pro "
        "sound.",
        "129.00", 60,
    ),
    (
        "PHN-IP16", "smartphones",
        "Apple iPhone 16", "apple-iphone-16",
        "6.1-inch smartphone with the A18 chip, advanced camera system, and the "
        "Action button.",
        "799.00", 50,
    ),
    (
        "PHN-GALS25", "smartphones",
    ...
    (
        "TVS-FTV4KP", "tv-streaming",
        "Amazon Fire TV Stick 4K Plus", "amazon-fire-tv-stick-4k-plus",
        "4K streaming media player with Wi-Fi 6E support and an Alexa Voice "
        "Remote.",
        "59.00", 120,
    ),
    (
        "TVS-ECHODOT", "tv-streaming",
    ...
    (
        "TVS-SAM43U8000F", "tv-streaming",
        'Samsung 43" Crystal UHD U8000F 4K TV',
        "samsung-43-crystal-uhd-u8000f-4k-tv",
        "43-inch 4K UHD smart TV with Crystal Processor 4K and built-in "
        "streaming apps.",
        "379.00", 20,
    ),
    (
        "TVS-ROKU50SEL", "tv-streaming",
        'Roku Select Series 50" 4K HDR TV', "roku-select-series-50-4k-hdr-tv",
        "50-inch 4K HDR smart TV running Roku OS with an enhanced voice remote.",
        "299.00", 20,
    ),
    (
        "ACC-MXM3S", "accessories",
        "Logitech MX Master 3S", "logitech-mx-master-3s",
        "Advanced wireless mouse with quiet clicks, an 8K DPI sensor, and "
        "MagSpeed scrolling.",
        "99.00", 70,
    ),
    (
        "ACC-KEYK2", "accessories",
        "Keychron K2 Mechanical Keyboard", "keychron-k2-mechanical-keyboard",
        "Compact 75% wireless mechanical keyboard compatible with Mac and "
        "Windows.",
        "99.00", 55,
    ),
    (
        "ACC-BRIO4K", "accessories",
        "Logitech Brio 4K Webcam", "logitech-brio-4k-webcam",
        "4K Ultra HD webcam with HDR and autofocus for sharp video calls and "
        "streaming.",
        "199.00", 38,
    ),
]
