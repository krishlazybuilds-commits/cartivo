...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'ordering': ['-created_at'],
                'constraints': [models.CheckConstraint(condition=models.Q(('value__gt', 0)), name='coupon_value_positive'), models.CheckConstraint(condition=models.Q(('min_order_amount__gte', 0)), name='coupon_min_order_non_negative')],
            },
        ),
        migrations.AddField(
            model_name='order',
